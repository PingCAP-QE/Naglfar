...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChaosApplyInstance) DeepCopyInto(out *ChaosApplyInstance) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChaosApplyInstance.
func (in *ChaosApplyInstance) DeepCopy() *ChaosApplyInstance {
	if in == nil {
		return nil
	}
	out := new(ChaosApplyInstance)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ChaosApplyStatus) DeepCopyInto(out *ChaosApplyStatus) {
	*out = *in
	if in.ApplyTable != nil {
		in, out := &in.ApplyTable, &out.ApplyTable
		*out = make(map[string]*ChaosResourcesInstance, len(*in))
		for key, val := range *in {
			var outVal *ChaosResourcesInstance
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(ChaosResourcesInstance)
				**out = **in
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChaosResourcesInstance) DeepCopyInto(out *ChaosResourcesInstance) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChaosResourcesInstance.
func (in *ChaosResourcesInstance) DeepCopy() *ChaosResourcesInstance {
	if in == nil {
		return nil
	}
	out := new(ChaosResourcesInstance)

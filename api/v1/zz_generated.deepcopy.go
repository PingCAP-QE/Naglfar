...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerStat) DeepCopyInto(out *ContainerStat) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerStat.
func (in *ContainerStat) DeepCopy() *ContainerStat {
	if in == nil {
		return nil
	}
	out := new(ContainerStat)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestResourceStatus) DeepCopyInto(out *TestResourceStatus) {
	*out = *in
	if in.HostMachine != nil {
		in, out := &in.HostMachine, &out.HostMachine
